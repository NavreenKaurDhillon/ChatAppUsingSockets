...
abstract class ImagePickerUtilityFragment<VB : ViewBinding> : Fragment() {
...
//        dialog.window!!.attributes.windowAnimations = R.style.Theme_Dialog
    ...
    private fun captureImage() {
        ...
        val fileUri = FileProvider.getUriForFile(
            Objects.requireNonNull(mActivity!!), "com.example.chatappusingsockets.provider",
            mImageFile
        )
    ...
    private fun checkPermissionDenied(permissions: String) {
        if (shouldShowRequestPermissionRationale(permissions)) {
            ...
            val dialog: AlertDialog =
                mBuilder.setTitle("Alert").setMessage("Permissions required")
                    .setPositiveButton(
                      "ok"
            ...
            dialog.setOnShowListener {
                dialog.getButton(AlertDialog.BUTTON_POSITIVE).setTextColor(
                    ContextCompat.getColor(
                        mActivity!!, androidx.appcompat.R.color.error_color_material_dark
                    )
                )
            }
            dialog.show()
            ...
            val dialog: AlertDialog =
                builder.setTitle("ALert").setMessage("Permissions Required")
                    .setCancelable(
                        false
                    )
                    .setPositiveButton("Open settings") { dialog, which ->
                        ...
                        val intent = Intent(
                            ...
                            Uri.fromParts(
                                "package",
                                "com.example.chatappusingsockets",
                                null
                            )
                        )
            ...
            dialog.setOnShowListener {
                dialog.getButton(AlertDialog.BUTTON_POSITIVE).setTextColor(
                    ContextCompat.getColor(
                        mActivity!!, androidx.constraintlayout.widget.R.color.error_color_material_dark
                    )
                )
            }
            dialog.show()
